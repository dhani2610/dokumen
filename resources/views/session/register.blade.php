            ...
            <form action="{{ url('register') }}" method="POST" enctype="multipart/form-data">
                @csrf
                  ...
                  <input type="hidden" name="role" value="User">
                    ...
                    <input type="number" name="stambuk" placeholder="Stambuk / NIDN"  required/>
        ...
        <div class="toggle-container">
            <div class="toggle">
                <div class="toggle-panel toggle-right">
                    <h1>Management Document!</h1>
                    <button onclick="location.href='{{ url('login') }}'"  class="hidden" >Sign in</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
  window.onload = function() {
      ...
      input.addEventListener('keyup', function() {
          ...
          if (!isValid) {
              msg.innerText = "Nomor harus berupa angka dengan panjang 8-16 karakter.";
